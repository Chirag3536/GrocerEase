    ...
    <div className="">
      <section className="-z-50 banner relative flex flex-col justify-center items-center">
        <div className="w-[50vw] z-10 text-center">
          <p className="text-2xl lg:text-7xl font-bold z-10 py-5">GrocerEase</p>
          <p className="z-10   text-gray-300 text-xl lg:text-4xl">
          Experience the freshest produce and daily essentials delivered straight to your doorstep with GrocerEase. Join our community of savvy shoppers and discover a seamless, eco-friendly way to grocery shop online!
          </p>
        </div>
